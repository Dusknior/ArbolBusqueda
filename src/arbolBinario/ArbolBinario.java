...
public class ArbolBinario {
    ...
    public ArbolBinario agregarEspejo(ArbolBinario pedirArbol){
       pedirArbol.raiz = ArbolEspejo(pedirArbol.raiz);
       return pedirArbol;
    }
    public Nodo ArbolEspejo(Nodo dato){
        if(dato == null){
            return null;
        }
        Nodo temporal = dato.getIzq();
        dato.setIzq(ArbolEspejo(dato.getDer()));
        dato.setDer(ArbolEspejo(temporal));
        return dato;
    }
    public Nodo insertarEspejo(Nodo nuevo, Nodo pivote) {
        if (this.raiz == null) {
            raiz = nuevo;
        } else {
            if (nuevo.getDato() >= pivote.getDato()) {
